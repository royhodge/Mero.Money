...
#if defined(NDEBUG)
#error "Mero cannot be compiled without assertions."
#endif
...
*/
    ...
    // SPORK_15 is used for 70812. Nodes < 70812 don't see it and still get their protocol version via SPORK_14 and their
